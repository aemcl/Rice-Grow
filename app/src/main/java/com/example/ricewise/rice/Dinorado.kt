...
fun Dinorado(){
    ...
    Column(
        ...
        Text(
            text = "Dinorado is another rice variety known for its aromatic qualities and high-quality grains. " +
        ...
        Column(
            ...
            Text(
                text = "About 3 to 4 Months (Between September & December)",fontWeight = FontWeight.Light, fontSize = 18.sp
            )
        }
    }
}