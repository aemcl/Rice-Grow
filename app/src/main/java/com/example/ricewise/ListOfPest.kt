...
fun ListOfPest(navController: NavController){
    ...
    val pestList = listOf(
        "Rice Stem Borer" to Routes.ricestemborer,
        "Scirpophaga Incertulas" to Routes.scirpophaga,
        "Adult Stem Borer" to Routes.adult,
        "Rice Caseworm Nymphula depunctalis" to Routes.caseworm,
    )
